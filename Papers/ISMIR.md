...
| Year | Name | Technical Class | Model |
|-|-|-|-|
|   2019  |   LEARNING SEMANTIC SIMILARITY IN MUSIC VIA SELF-SUPERVISION  |   Music Recognition /Similarity  |   Adversarial Network  |
|   2019  |   LEARNING COMPLEX BASIS FUNCTIONS FOR INVARIANT REPRESENTATIONS OF AUDIO  |   Music Analysis  |   Autoencoder  |
|   2019  |   LEARNING DISENTANGLED REPRESENTATIONS OF TIMBRE AND PITCH FOR MUSICAL INSTRUMENT SOUNDS USING GAUSSIAN MIXTURE VARIATIONAL AUTOENCODERS  |   Pitch Detection  |   Autoencoder  |
|   2019  |   A CONVOLUTIONAL APPROACH TO MELODY LINE IDENTIFICATION IN SYMBOLIC SCORES  |   Melody Extraction  |   CNN  |
|   2019  |   ADAPTIVE TIME–FREQUENCY SCATTERING FOR PERIODIC MODULATION RECOGNITION IN MUSIC SIGNALS  |   Expression Identification  |   CNN  |
|   2019  |   CONDITIONED-U-NET: INTRODUCING A CONTROL MECHANISM IN THE U-NET FOR MULTIPLE SOURCE SEPARATIONS  |   Source Separation  |   CNN  |
|   2019  |   CONVOLUTIONAL COMPOSER CLASSIFICATION  |   Music Classification/ Tagging  |   CNN  |
|   2019  |   DEEP-RHYTHM FOR TEMPO ESTIMATION AND RHYTHM PATTERN RECOGNITION  |   Beat Tracking / Detection  |   CNN  |
|   2019  |   FOLDED CQT RCNN FOR REAL-TIME RECOGNITION OF INSTRUMENT PLAYING TECHNIQUES  |   Instrument Identification  |   CNN  |
|   2019  |   GUITAR TABLATURE ESTIMATION WITH A CONVOLUTIONAL NEURAL NETWORK  |   Auto Playing  |   CNN  |
|   2019  |   IDENTIFICATION AND CROSS-DOCUMENT ALIGNMENT OF MEASURES IN MUSIC SCORE IMAGES  |   OMR  |   CNN  |
|   2019  |   MODELING MUSIC MODALITY   WITH A KEY-CLASS INVARIANT PITCH CHROMA CNN  |   Music Analysis  |   CNN  |
|   2019  |   MODELING MUSIC MODALITY WITH A KEY-CLASS INVARIANT PITCH CHROMA CNN  |   Music Analysis / Pitch Detection  |   CNN  |
|   2019  |   THE BACH DOODLE: APPROACHABLE MUSIC COMPOSITION WITH MACHINE LEARNING AT SCALE  |   Generation  |   CNN  |
|   2019  |   INVESTIGATING CNN-BASED INSTRUMENT FAMILY RECOGNITION FOR WESTERN CLASSICAL MUSIC RECORDINGS  |   Instrument Identification  |   CNN  |
|   2019  |   QUERY BY VIDEO: CROSS-MODAL MUSIC RETRIEVAL  |   Music Recognition / Detection  |   CNN FCN  |
|   2019  |   LARGE-VOCABULARY CHORD TRANSCRIPTION VIA CHORD STRUCTURE DECOMPOSITION  |   Chord Recognition  |   CRNN  |
|   2019  |   LEARNING SOFT-ATTENTION MODELS FOR TEMPO-INVARIANT AUDIO-SHEET MUSIC RETRIEVAL  |   Data Matching  |   Deep Learning  |
|   2019  |   AUTOMATIC CHOREOGRAPHY GENERATION WITH CONVOLUTIONAL ENCODER-DECODER NETWORK  |   Others  |   Encoder-Decoder  |
|   2019  |   LEARNING SIMILARITY METRICS FOR MELODY RETRIEVAL  |   Music Recognition /Similarity  |   Encoder-Decoder  |
|   2019  |   SUPERVISED SYMBOLIC MUSIC STYLE TRANSLATION USING SYNTHETIC DATA  |   Style Transfering  |   Encoder-Decoder  |
|   2019  |   AN ATTENTION MECHANISM FOR MUSICAL INSTRUMENT RECOGNITION  |   Music Recognition / Detection /Automatic music transcription  |   FCN  |
|   2019  |   AN INTERACTIVE WORKFLOWFOR GENERATING CHORD LABELS FOR HOMORHYTHMIC MUSIC IN SYMBOLIC FORMATS  |   Music Analysis / Chord Recognition  |   FCN  |
|   2019  |   AUTO-ADAPTIVE RESONANCE EQUALIZATION USING DILATED RESIDUAL NETWORKS  |   Automatic Equalization  |   FCN  |
|   2019  |   A COMPARATIVE STUDY OF NEURAL MODELS   FOR POLYPHONIC MUSIC SEQUENCE TRANSDUCTION  |   Automatic music transcription  |   GAN  |
|   2019  |   ADVERSARIAL LEARNING FOR IMPROVED ONSETS AND FRAMES MUSIC TRANSCRIPTION  |   Automatic music transcription  |   GAN/pix2pix  |
|   2019  |   QUERY-BY-BLENDING: A MUSIC EXPLORATION SYSTEM BLENDING LATENT VECTOR REPRESENTATIONS OF LYRIC WORD, SONG AUDIO, AND ARTIST  |   Music Classification/ Tagging  |   k-means  |
|   2019  |   TRACKING BEATS AND MICROTIMING IN AFRO-LATIN AMERICAN MUSIC USING CONDITIONAL RANDOM FIELDS AND DEEP LEARNING  |   Beat Tracking / Detection  |   Language Model/  |
|   2019  |   BLENDING ACOUSTIC AND LANGUAGE MODEL PREDICTIONS FOR AUTOMATIC MUSIC TRANSCRIPTION  |   Automatic music transcription  |   LSTM  |
|   2019  |   ESTIMATING UNOBSERVED AUDIO FEATURES FOR TARGET-BASED ORCHESTRATION  |   Orchestration / Arrangement  |   LSTM  |
|   2019  |   LEARNING TO GENERATE MUSIC WITH SENTIMENT  |   Generation  |   LSTM  |
|   2019  |   TOWARDS AUTOMATICALLY CORRECTING TAPPED BEAT ANNOTATIONS FOR MUSIC RECORDINGS  |   Beat Tracking / Detection  |   LSTM  |
|   2019  |   DEEPSRGM - SEQUENCE CLASSIFICATION AND RANKING IN INDIAN CLASSICAL MUSIC WITH DEEP LEARNING  |   Music Recognition  |   LSTM-RNN  |
